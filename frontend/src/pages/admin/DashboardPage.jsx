...
const DashboardPage = () => {
  return (
    <div className="space-y-6 p-2">
      <div>
        <h1 className="text-3xl font-extrabold text-gray-900 tracking-tight dark:text-white ">Bảng điều khiển</h1>
        <p className="text-gray-500 text-sm mt-1 font-medium dark:text-amber-50/50">
