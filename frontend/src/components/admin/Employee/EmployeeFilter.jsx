    ...
    <div className="space-y-6">
      ...
      <div className="bg-white p-4 rounded-2xl border border-gray-100 shadow-xs space-y-4 dark:bg-gray-900 dark:border-gray-800">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-3 items-center">
          ...
          <div className="md:col-span-5 flex items-center bg-gray-100 dark:bg-gray-800/80 p-1 rounded-xl gap-1">
            <Button
              type="button"
              variant="ghost"
              size="sm"
              ...
              className={`flex-1 h-auto py-1.5 text-xs font-semibold rounded-lg transition-all cursor-pointer ${selectedStatus === 'all'
                  ? 'bg-white dark:bg-gray-700 text-gray-900 dark:text-white shadow-xs hover:bg-white dark:hover:bg-gray-700'
                  : 'text-gray-500 dark:text-gray-400 hover:bg-transparent hover:text-gray-700 dark:hover:text-gray-200'
                }`}
            >
              Tất cả
            </Button>
            ...
            <Button
              ...
              className={`flex-1 h-auto py-1.5 text-xs font-semibold rounded-lg transition-all cursor-pointer ${selectedStatus === 'leave'
                  ? 'bg-amber-500 text-white shadow-xs hover:bg-amber-600 dark:bg-amber-600 dark:hover:bg-amber-700'
                  : 'text-gray-500 dark:text-gray-400 hover:bg-transparent hover:text-gray-700 dark:hover:text-gray-200'
                }`}
            >
              Đang nghỉ
            ...
            <Button
              ...
              className={`flex-1 h-auto py-1.5 text-xs font-semibold rounded-lg transition-all cursor-pointer ${selectedStatus === 'disable'
